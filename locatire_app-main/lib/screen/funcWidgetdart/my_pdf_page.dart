  ...
  Future<void> generateAndSavePDF() async {
                ...
                pw.Column(
                  ...
                  children: [
                          ...
                          pw.SizedBox(
                            ...
                            child: pw.RichText(
                                text: pw.TextSpan(
                                  ...
                                  pw.TextSpan(
                                      text:
                                          "${widget.myProperty!.propertyID + widget.myTenant!.tenantID}",
                                      style: pw.TextStyle(
                                          fontWeight: pw.FontWeight.bold,
                                          fontSize: 14.sp,
                                          font: pw.Font.helvetica()))
                      ...
                      children: [
                        pw.Padding(
                          padding: const pw.EdgeInsets.only(
                              right: 20.0, left: 20.0, bottom: 3, top: 3),
                          child: pw.Column(
                            children: [
                              pw.SizedBox(
                                width: size.width * .45,
                                child: pw.Text("Propiétaire : ",
                                    style: pw.TextStyle(
                                      fontWeight: pw.FontWeight.bold,
                                      fontSize: 14.sp,
                                      font: pw.Font.helvetica(),
                                      color:
                                          const PdfColor(0.08, 0.56, 0.65, 0.8),
                                    )),
                              ),
                              pw.SizedBox(
                                  width: size.width * .45,
                                  child: pw.Text("Nom : ANAGO ",
                                      style: pw.TextStyle(
                                          fontWeight: pw.FontWeight.bold,
                                          fontSize: 13.sp,
                                          font: pw.Font.helvetica()
                              ...
                              pw.SizedBox(
                                  width: size.width * .45,
                                  child: pw.Text("Tel : 00000000 / 00000000   ",
                                      style: pw.TextStyle(
                                          fontWeight: pw.FontWeight.bold,
                                          fontSize: 13.sp,
                                          font: pw.Font.helvetica()
                          ...
                          child: pw.Column(
                            children: [
                              ...
                              pw.SizedBox(
                                  width: size.width * .45,
                                  child: pw.Text(
                                      "Nom : ${widget.myTenant!.tenantName}",
                                      style: pw.TextStyle(
                                          fontWeight: pw.FontWeight.bold,
                                          fontSize: 13.sp,
                                          font: pw.Font.helvetica()
                              ...
                              pw.SizedBox(
                                  width: size.width * .45,
                                  child: pw.Text(
                                      "Prénoms : ${widget.myTenant!.tenantLastName}",
                                      style: pw.TextStyle(
                                          fontWeight: pw.FontWeight.bold,
                                          fontSize: 13.sp,
                                          font: pw.Font.helvetica()
                              ...
                              pw.SizedBox(
                                  width: size.width * .45,
                                  child: pw.Text(
                                      "Tel :${widget.myTenant!.tenantContact1} / ${widget.myTenant!.tenantContact2}",
                                      style: pw.TextStyle(
                                          fontWeight: pw.FontWeight.bold,
                                          fontSize: 13.sp,
                                          font: pw.Font.helvetica()
                    ...
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(20.0),
                      child: pw.Text(
                          "Le locataire doit conserver cette preuve de paiement pendant toute la durée du contrat de bail qui le lie au bailleur.",
                          style: pw.TextStyle(
                              color: const PdfColor(0.08, 0.56, 0.65, 0.8),
                              fontWeight: pw.FontWeight.bold,
                              fontSize: 14.sp,
    ...
    print("Permission de stockage refusée");
      ...
      if (await Permission.storage.isGranted) {
        print("is granted");
        final output1 = await getExternalStorageDirectory();
        final newDirectory = Directory("${output1!.path}/pppppoooiiiuuuu12");
        if (!newDirectory.existsSync()) {
          try {
            newDirectory.createSync(recursive: true);
            print("c'est créé : $newDirectory");
          } catch (e) {
            print(e);
          }
        }
      ...
      print(
          "Erreur lors de la création ou de la sauvegarde du fichier PDF : $e");
    }
/*
